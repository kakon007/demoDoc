...
flutter build apk  --flavor dev --target-platform android-arm,android-arm64 --debug
flutter build apk  --flavor dev --target-platform android-arm,android-arm64 --profile
