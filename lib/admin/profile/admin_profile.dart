...
import 'package:myhealthbd_app/admin/profile/widgets/change_password_admin.dart';
import 'package:myhealthbd_app/admin/profile/widgets/company_info_admin.dart';
import 'package:myhealthbd_app/admin/profile/widgets/personal_info_admin.dart';
  ...
  Widget build(BuildContext context) {
    ...
    var personalInfoTab = GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: index == 1 ? AppTheme.appbarPrimary : Colors.white,
    ...
    var changePasswordTab = GestureDetector(
      onTap: () {
        setState(() {
          index = 2;
        });
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: index == 2 ? AppTheme.appbarPrimary : Colors.white,
            border: Border(
              left: BorderSide(
    ...
    var companyInfoTab = GestureDetector(
      onTap: () {
        setState(() {
          index = 3;
        });
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: index == 3 ? AppTheme.appbarPrimary : Colors.white,
            borderRadius: BorderRadius.only(
          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Row(
                  children: [personalInfoTab, changePasswordTab, companyInfoTab],
                ),
              ),
            ),
          ],
