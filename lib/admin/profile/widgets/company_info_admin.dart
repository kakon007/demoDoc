...
class CompanyInfoAdmin extends StatefulWidget {
  const CompanyInfoAdmin({Key key}) : super(key: key);

  @override
  _CompanyInfoAdminState createState() => _CompanyInfoAdminState();
}

class _CompanyInfoAdminState extends State<CompanyInfoAdmin> {
