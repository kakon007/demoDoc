...
class PrescriptionModuleWidget extends StatefulWidget {
  @override
  _PrescriptionModuleWidgetState createState() =>
      _PrescriptionModuleWidgetState();
}

class _PrescriptionModuleWidgetState extends State<PrescriptionModuleWidget> {
    ...
    return Column(
      children: [
        ...
        isTapped
            ...
            //                   activeColor: Color(0xff141D53),
            //                   value: this.prescriptionWorkList,
            //                   onChanged: (bool value) {
            //                     setState(() {
            //                       this.prescriptionWorkList = value;
            //                     });
            //                   }),
            //               Text(
            //                 'Prescription Work List',
            //                 style: GoogleFonts.poppins(fontSize: 14),
            //               ),
            //             ],
            //           ),
            ...
            //                   materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
            //                   activeColor: Color(0xff141D53),
            //                   value: this.prescriptionGlobal,
            //                   onChanged: (bool value) {
            //                     setState(() {
            //                       this.prescriptionGlobal = value;
            //                     });
            //                   }),
            //               Text(
            //                 'Prescription Global',
            ...
            //                   }),
            //               Text(
            //                 'Video Conference Button Access',
            //                 style: GoogleFonts.poppins(fontSize: 14),
            //               ),
            //             ],
            //           ),
            ...
            //                   materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
            //                   activeColor: Color(0xff141D53),
            //                   value: this.doctorSetup,
            //                   onChanged: (bool value) {
            //                     setState(() {
            //                       this.doctorSetup = value;
            //                     });
            //                   }),
            //               Text(
            //                 'Doctor Wise Pres Setup',
            //                 style: GoogleFonts.poppins(fontSize: 14),
            //               ),
            //             ],
            //           ),
            ...
            //                   materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
            //                   activeColor: Color(0xff141D53),
            //                   value: this.dosageSetup,
            //                   onChanged: (bool value) {
            //                     setState(() {
            //                       this.dosageSetup = value;
            //                     });
            //                   }),
            //               Text(
            //                 'Dosage Setup',
