...
class Obj {
  ...
  factory Obj.fromJson(Map<String, dynamic> json) => Obj(
    ...
    treatmentList: json["treatmentList"] == null ? null : List<dynamic>.from(json["treatmentList"].map((x) => x)),
    diseaseList: json["diseaseList"] == null ? null : List<dynamic>.from(json["diseaseList"].map((x) => x)),
    chiefComplainList: json["chiefComplainList"] == null ? null : List<Note>.from(json["chiefComplainList"].map((x) => Note.fromJson(x))),
    finalizationThreeList: json["finalizationThreeList"] == null ? null : List<dynamic>.from(json["finalizationThreeList"].map((x) => x)),
    clinicalHistoryNote: json["clinicalHistoryNote"],
    clinicalHistory2List: json["clinicalHistory2List"] == null ? null : List<Note>.from(json["clinicalHistory2List"].map((x) => Note.fromJson(x))),
    medicationNote: json["medicationNote"],
    department: json["department"],
    prescriptionTemp: json["prescriptionTemp"] == null ? null : PrescriptionTemp.fromJson(json["prescriptionTemp"]),
    adviceList: json["adviceList"] == null ? null : List<Note>.from(json["adviceList"].map((x) => Note.fromJson(x))),
    eyeIpd: json["eyeIPD"],
    dietAdviceList: json["dietAdviceList"] == null ? null : List<dynamic>.from(json["dietAdviceList"].map((x) => x)),
    patHistoryList: json["patHistoryList"] == null ? null : List<dynamic>.from(json["patHistoryList"].map((x) => x)),
    referralDoctorList: json["referralDoctorList"] == null ? null : List<dynamic>.from(json["referralDoctorList"].map((x) => x)),
    investigationNote: json["investigationNote"],
    eyeRemarks: json["eyeRemarks"],
    patPhysicalExamList: json["patPhysicalExamList"] == null ? null : List<dynamic>.from(json["patPhysicalExamList"].map((x) => x)),
    finalizationOneList: json["finalizationOneList"] == null ? null : List<dynamic>.from(json["finalizationOneList"].map((x) => x)),
    medicineList: json["medicineList"] == null ? null : List<dynamic>.from(json["medicineList"].map((x) => x)),
    investigationList: json["investigationList"] == null ? null : List<Note>.from(json["investigationList"].map((x) => Note.fromJson(x))),
    clinicalHistory3List: json["clinicalHistory3List"] == null ? null : List<Note>.from(json["clinicalHistory3List"].map((x) => Note.fromJson(x))),
    finalizationTwoList: json["finalizationTwoList"] == null ? null : List<dynamic>.from(json["finalizationTwoList"].map((x) => x)),
    medicationList: json["medicationList"] == null ? null : List<MedicationList>.from(json["medicationList"].map((x) => MedicationList.fromJson(x))),
    diagnosisList: json["diagnosisList"] == null ? null : List<dynamic>.from(json["diagnosisList"].map((x) => x)),
    dentalTreatment: json["dentalTreatment"],
    clinicalHistoryList: json["clinicalHistoryList"] == null ? null : List<Note>.from(json["clinicalHistoryList"].map((x) => Note.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "note": note == null ? null : note.toJson(),
    "treatmentList": treatmentList == null ? null : List<dynamic>.from(treatmentList.map((x) => x)),
    "diseaseList": diseaseList == null ? null : List<dynamic>.from(diseaseList.map((x) => x)),
    "chiefComplainList": chiefComplainList == null ? null : List<dynamic>.from(chiefComplainList.map((x) => x.toJson())),
    "finalizationThreeList": finalizationThreeList == null ? null : List<dynamic>.from(finalizationThreeList.map((x) => x)),
    "clinicalHistoryNote": clinicalHistoryNote,
    "clinicalHistory2List": clinicalHistory2List == null ? null : List<dynamic>.from(clinicalHistory2List.map((x) => x.toJson())),
    "medicationNote": medicationNote,
    "department": department,
    "prescriptionTemp": prescriptionTemp == null ? null : prescriptionTemp.toJson(),
    "adviceList": adviceList == null ? null : List<dynamic>.from(adviceList.map((x) => x.toJson())),
    "eyeIPD": eyeIpd,
    "dietAdviceList": dietAdviceList == null ? null : List<dynamic>.from(dietAdviceList.map((x) => x)),
    "patHistoryList": patHistoryList == null ? null : List<dynamic>.from(patHistoryList.map((x) => x)),
    "referralDoctorList": referralDoctorList == null ? null : List<dynamic>.from(referralDoctorList.map((x) => x)),
    "investigationNote": investigationNote,
    "eyeRemarks": eyeRemarks,
    "patPhysicalExamList": patPhysicalExamList == null ? null : List<dynamic>.from(patPhysicalExamList.map((x) => x)),
    "finalizationOneList": finalizationOneList == null ? null : List<dynamic>.from(finalizationOneList.map((x) => x)),
    "medicineList": medicineList == null ? null : List<dynamic>.from(medicineList.map((x) => x)),
    "investigationList": investigationList == null ? null : List<dynamic>.from(investigationList.map((x) => x.toJson())),
    "clinicalHistory3List": clinicalHistory3List == null ? null : List<dynamic>.from(clinicalHistory3List.map((x) => x.toJson())),
    "finalizationTwoList": finalizationTwoList == null ? null : List<dynamic>.from(finalizationTwoList.map((x) => x)),
    "medicationList": medicationList == null ? null : List<dynamic>.from(medicationList.map((x) => x.toJson())),
    "diagnosisList": diagnosisList == null ? null : List<dynamic>.from(diagnosisList.map((x) => x)),
    "dentalTreatment": dentalTreatment,
    "clinicalHistoryList": clinicalHistoryList == null ? null : List<dynamic>.from(clinicalHistoryList.map((x) => x.toJson())),
  };
}
...
class Note {
  ...
  factory Note.fromJson(Map<String, dynamic> json) => Note(
    ...
    preDiagnosisVal: json["preDiagnosisVal"] == null ? null : json["preDiagnosisVal"],
    preDiagnosisValType: json["preDiagnosisValType"] == null ? null : json["preDiagnosisValType"],
    ...
    inReportSerial: json["inReportSerial"] == null ? null : json["inReportSerial"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "preDiagnosisValType": preDiagnosisValType == null ? null : preDiagnosisValType,
...
class MedicationList {
  ...
  factory MedicationList.fromJson(Map<String, dynamic> json) => MedicationList(
    ...
    ssModifiedOn: json["ssModifiedOn"] == null ? null : ssEdOnValues.map[json["ssModifiedOn"]],
    ssModifiedSession: json["ssModifiedSession"] == null ? null : json["ssModifiedSession"],
    presMedDtlList: json["presMedDtlList"] == null ? null : List<PresMedDtlList>.from(json["presMedDtlList"].map((x) => PresMedDtlList.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "ssModifiedOn": ssModifiedOn == null ? null : ssEdOnValues.reverse[ssModifiedOn],
    "ssModifiedSession": ssModifiedSession == null ? null : ssModifiedSession,
    "presMedDtlList": presMedDtlList == null ? null : List<dynamic>.from(presMedDtlList.map((x) => x.toJson())),
  };
}
...
class PresMedDtlList {
  ...
  factory PresMedDtlList.fromJson(Map<String, dynamic> json) => PresMedDtlList(
    ...
    medicineComment: json["medicineComment"] == null ? null : json["medicineComment"],
    eye: json["eye"],
    eyeDrop: json["eyeDrop"],
    inReportSerial: json["inReportSerial"] == null ? null : json["inReportSerial"],
    isDeleted: json["isDeleted"] == null ? null : json["isDeleted"],
    continueFlag: json["continueFlag"] == null ? null : json["continueFlag"],
    activeStatus: json["activeStatus"] == null ? null : json["activeStatus"],
  );
