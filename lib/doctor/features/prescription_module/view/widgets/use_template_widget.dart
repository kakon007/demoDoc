...
class _UseTemplateWidgetState extends State<UseTemplateWidget> {
  var vm = Provider.of<PrescriptionTamplateViewModel>(appNavigator.context,
      listen: false);
  ...
  void searchFavoriteItem(String query) {
    ...
    if (query.isNotEmpty) {
      List<Item> initialFavoriteSearchItems = List<Item>();
                            ...
                            children: [
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                        ...
                                        suffixIcon: IconButton(
                                          ...
                                          key:
                                              Key('notCompletedSearchFieldKey'),
                                          onPressed: () {
                                                        ...
                                                        InkWell(
                                                            onTap: () async {
                                                              SVProgressHUD.show(
                                                                  status:
                                                                      'Deleting');
                                                              await DeleteTemplateRepository()
                                                                  .deleteList(
                                                                      id: favoriteItems[
                                                                              index]
                                                                          .id)
                              ...
                              InkWell(
                                onTap: () {
                                  ...
                                  templateVm.getData(templateId: vm.id);
