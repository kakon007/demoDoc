...
class VitalsFormField extends StatelessWidget {
      ...
      child: Column(
        children: [
          TextFormField(
            ...
            //       fontSize: hintSize, color: HexColor("#D2D2D2")),
            //   focusedBorder: OutlineInputBorder(
            //     borderSide:
            //         BorderSide(color: HexColor(focusBorderColor), width: 1.0),
            //     borderRadius: BorderRadius.circular(borderRadius),
            //   ),
            //   contentPadding: EdgeInsets.fromLTRB(leftContentPadding,
            //       topContentPadding, rightContentPadding, 0.0),
            //   enabledBorder: OutlineInputBorder(
            //     borderSide:
            //         BorderSide(color: HexColor(enabledBorderColor), width: 1.0),
            //     borderRadius: BorderRadius.circular(borderRadius),
            //   ),
