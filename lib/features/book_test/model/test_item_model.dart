...
TestItemModel testItemModelFromJson(String str) =>
    TestItemModel.fromJson(json.decode(str));
...
class TestItemModel {
  ...
  factory TestItemModel.fromJson(Map<String, dynamic> json) => TestItemModel(
        ...
        items: json["items"] == null
            ? null
            : List<TestItem>.from(
                json["items"].map((x) => TestItem.fromJson(x))),
...
class TestItem {
  ...
  factory TestItem.fromJson(Map<String, dynamic> json) => TestItem(
        ...
        itemTypeName: json["itemTypeName"] == null
            ? null
            : itemTypeNameValues.map[json["itemTypeName"]],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "itemTypeName": itemTypeName == null
            ? null
            : itemTypeNameValues.reverse[itemTypeName],
...
final itemTypeNameValues = EnumValues({"PATHOLOGY": ItemTypeName.PATHOLOGY});
