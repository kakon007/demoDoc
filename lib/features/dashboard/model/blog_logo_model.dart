...
//
//     final blogLogoModel = blogLogoModelFromJson(jsonString);

import 'dart:convert';

BlogLogoModel blogLogoModelFromJson(String str) => BlogLogoModel.fromJson(json.decode(str));

String blogLogoModelToJson(BlogLogoModel data) => json.encode(data.toJson());
...
class BlogLogoModel {
  ...
  factory BlogLogoModel.fromJson(Map<String, dynamic> json) => BlogLogoModel(
