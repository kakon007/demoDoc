...
//
//     final doctorsGridModel = doctorsGridModelFromJson(jsonString);

import 'dart:convert';

DoctorsGridModel doctorsGridModelFromJson(String str) => DoctorsGridModel.fromJson(json.decode(str));

String doctorsGridModelToJson(DoctorsGridModel data) => json.encode(data.toJson());
...
class DoctorsGridModel {
  ...
  factory DoctorsGridModel.fromJson(Map<String, dynamic> json) => DoctorsGridModel(
