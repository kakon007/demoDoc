...
class DoctorListViewModel extends ChangeNotifier {
  ...
  Future<void> getDoctor(String orgNo, String companyNo, String deptItem,
      String specialSelectedItem, String doctorSearch) async {
    _doctor.clear();
    print(deptItem);
    ...
    var res = await DoctorListRepository().getDoctorList(
        orgNo: orgNo,
        companyNo: companyNo,
        deptItem: deptItem,
        specialSelectedItem: specialSelectedItem,
  ...
  getMoreData(String orgNo, String companyNo, String deptItem,
      String specialSelectedItem, String doctorSearch) async {
    if (!isFetchingMoreData && !isFetchingData && hasMoreData) {
      startIndex += limit;
      _pageCount++;
      isFetchingMoreData = true;
      Either<AppError, DoctorListModel> result = await DoctorListRepository()
          .getDoctorList(
  ...
  bool get shouldShowPageLoader => _isFetchingData && _doctor.length == 0;
