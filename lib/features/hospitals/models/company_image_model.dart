...
//
//     final companyImageModel = companyImageModelFromJson(jsonString);

import 'dart:convert';

CompanyImageModel companyImageModelFromJson(String str) => CompanyImageModel.fromJson(json.decode(str));

String companyImageModelToJson(CompanyImageModel data) => json.encode(data.toJson());
...
class CompanyImageModel {
  ...
  factory CompanyImageModel.fromJson(Map<String, dynamic> json) => CompanyImageModel(
...
class Item {
  ...
  factory Item.fromJson(Map<String, dynamic> json) => Item(
    ...
    photoImg: json["photoImg"] == null ? null : json["photoImg"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "photoImg": photoImg == null ? null : photoImg,
    "photoLogo": photoLogo,
  };
}
