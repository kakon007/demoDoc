...
//
//     final documentListModel = documentListModelFromJson(jsonString);

import 'dart:convert';

DocumentListModel documentListModelFromJson(String str) => DocumentListModel.fromJson(json.decode(str));

String documentListModelToJson(DocumentListModel data) => json.encode(data.toJson());
