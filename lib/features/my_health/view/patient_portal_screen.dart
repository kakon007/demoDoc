                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              InkWell(
                                                                                  onTap: () async {
                                                                                    ...
                                                                                    _showAlertDialogForEditProfile(
                                                                                        context,
                                                                                        vm3
                                                                                            .documentList[
                                                                                                index]
                                                                                  ...
                                                                                  children: [
                                                                                    Padding(
                                                                                      ...
                                                                                      child: InkWell(
                                                                                          onTap: () async {
                                                                                            await downloadDocumentations(
                                                                                                vm3.documentList[index].attachmentPath,
                                                                                                vm3.documentList[index].attachmentName);
                                                                                          },
                                                                                          child: Icon(Icons.download_rounded,
                                                                                              key: Key('documentationDownloadKey$index'),
                                                                                              size: isTablet
                                                                                                  ? 25
                                                                                                  : deviceWidth <= 360
                                                                                                      ? 18
                                                                                    ...
                                                                                    Padding(
                                                                                      ...
                                                                                      child: GestureDetector(
                                                                                          onTap: () async {
                                                                                            ...
                                                                                            await vm10.getData(
                                                                                                fileNo:
                                                                                                    vm3.documentList[index].id);
                                                                                            await vm10.fileInfo(
                                                                                                fileNo:
                                                                                                    vm3.documentList[index].id,
                                                                                                regId: vm3.documentList[index].referenceNo);
                                                                                            SVProgressHUD
                                                                                                .dismiss();
                                                                                            vm3.documentList[index].id ==
                                                                                                    null
                                                                                                ? Fluttertoast.showToast(msg: 'No Documents Found')
                                                                                                : showModalBottomSheet(
                                                                                                    backgroundColor: HexColor("#E9ECFE"),
                                                                                                    ...
                                                                                                    builder: (context) {
                                                                                                      return StatefulBuilder(builder: (BuildContext context, StateSetter setState) {
                                                                                                        var index = 0;
                                                                                                        bool isTrue = false;
                                                                                                        return FractionallySizedBox(heightFactor: 0.85, child: ShareDocument());
                                                                                                      });
                                                                                                    });
                                                                                            //print('CompanyName ${vm10.sharedFileList.last.companyName}');
                                                                                          },
                                                                                          ...
                                                                                          onTap: () async {
                                                                                            ...
                                                                                            await Provider.of<UploadDocumentsViewModel>(context, listen: false)
                                                                                                .deleteDocuments(
                                                                                                    ...
                                                                                                    attachmentName: vm3.documentList[index].attachmentName,
                                                                                                    attachmentPath: vm3.documentList[index].attachmentPath,
                                                                                                    attachmentTypeNo: vm3.documentList[index].attachmentTypeNo,
                                                                                                    description: vm3.documentList[index].description,
                                                                                                    activeStatus: vm3.documentList[index].activeStatus,
                                                                                                    referenceNo: vm3.documentList[index].referenceNo,
                                                                                                    referenceTypeNo: vm3.documentList[index].referenceTypeNo,
                                                                                                    regId: vm3.documentList[index].regId,
                                                                                                    type: vm3.documentList[index].type)
                                                                                                .then((value) {
                                                                                              setState(
                                                                                                  () {
                                                                                                vm3.getDataforDoc();
