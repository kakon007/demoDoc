...
RegisteredMembersModel registeredMembersModelFromJson(String str) => RegisteredMembersModel.fromJson(json.decode(str));

String registeredMembersModelToJson(RegisteredMembersModel data) => json.encode(data.toJson());
...
class RegisteredMembersModel {
  ...
  factory RegisteredMembersModel.fromJson(Map<String, dynamic> json) => RegisteredMembersModel(
