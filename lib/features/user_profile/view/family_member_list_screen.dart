                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text("Add Family Members",
                            style: GoogleFonts.roboto(color: HexColor("#354291"),fontSize: isTablet? 18 : 15)),
                      ],
                    ),
                  ),
                ),
                                 ...
                                 GestureDetector(
                                    child: Container(
                                      ...
                                      child: Icon(Icons.delete_sweep,
                                          color: AppTheme.appbarPrimary, size: isTablet? 22 : 18 ,),
                                    ),
                                    onTap: () {
                                      familyVm.getSelectedUserImage(relationId: familyVm.familyMembersList[index].relation.toString(),regId: familyVm.familyMembersList[index].regId,id: familyVm.familyMembersList[index].id.toString(),name: familyVm.familyMembersList[index].fmName,image: familyVm.familyMembersList[index].photo,userId: familyVm.familyMembersList[index].fmRegId,relationName: familyVm.familyMembersList[index].relationName);
                                      showGeneralDialog(
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Column(
                                                              children: [
                                                                ...
                                                                SizedBox(
                                                                  height: isTablet? 10 : width<=330 ? 10 : 20,
                                                                ),
                                                                Padding(
                                                                  padding:  EdgeInsets.only(left: width*.08, right: width*0.08),
                                                                  child: Row(
                                                                        ...
                                                                        child: Container(
                                                                          ...
                                                                          child: FlatButton(
                                                                              ...
                                                                              shape: RoundedRectangleBorder(
                                                                                  borderRadius: BorderRadius.circular(10)),
                                                                              textColor: Colors.white,
                                                                              color: AppTheme.appbarPrimary ,child: Text("Remove",  style: GoogleFonts.poppins(fontSize: isTablet? 18 : 15))),
                                                                        ),
                                                                      ),
                                                                    ],
                                                                  ),
