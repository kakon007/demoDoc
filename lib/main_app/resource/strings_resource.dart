class StringResources {
  ...
  static List<String> organizationLists = ['Aalock', 'Isnlamic Bank Hospital'];
  ...
  //SettingsScreen
  static String cityHintText = "Dhaka";
  static String locationPreferenceText = "Location Preference";
  ...
  static var certificationCredentialUrlHintText = "Ex:https://jobxprss.com";
...
//  static var dateLogicWarningText = "Issue date needs to occur before expiry date";
  ...
  static var companySignInText = "Sign In as Company";
  ...
  static List<String> expertiseMessage = [
    ...
    'I\'ve studied it briefly in the past.',
  ...
  static var phoneHintText = "01XXXXXXXX";
...
//Contact Us
  ...
  static const String noRecentActivity = 'You have no recent activity';
  static String recentActivitiesText = "Recent Activities";
  static String preferencesText = "Preferences";
