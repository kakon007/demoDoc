...
class CustomCardNews extends StatelessWidget {
  ...
  String url;
  String index;
  CustomCardNews(@required this.image, @required this.titleText, @required this.subTitleText,
      @required this.url, this.index);
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
      constraints: BoxConstraints(
        minHeight: width <= 1250 && width >= 1000
            ? 175
            : width <= 999 && width >= 650
                ? 140
                : 120,
      ),
      width: width <= 1250 && width >= 1000
          ? 380
          : width <= 999 && width >= 650
              ? 340
              : 300,
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          Row(
                            children: [
                              Text(titleText,
                                  style: TextStyle(
                                      fontSize: width <= 1250 && width >= 1000
                                          ? 14
                                          : width <= 999 && width >= 650
                                              ? 12
                                              : 8,
                          ...
                          SizedBox(
                            height: width <= 1250 && width >= 1000 ? 10 : 5,
                          ),
                          Text(subTitleText,
                              maxLines: 3,
                              style: TextStyle(
                    ...
                    InkWell(
                      onTap: () {
                        if (url != null) {
                          if (url.isNotEmpty) UrlLauncherHelper.launchUrl(url);
                        }
                      },
                      child: Material(
                        elevation: 0,
