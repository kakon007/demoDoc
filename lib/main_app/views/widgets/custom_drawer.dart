                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 5,),
                      Container(width: 180,child: Text(userDetails?.address??"Dhaka", style: GoogleFonts.roboto(color: HexColor('#B8C2F8'),fontSize: 12),maxLines: 1,overflow: TextOverflow.ellipsis,)),
                      SizedBox(height: 8,),
                      Container(
                        width: 120,
                        height: 25,
