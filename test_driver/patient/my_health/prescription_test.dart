...
Future<void> prescriptionTest()async{

  group('Prescription list Test', ()
  {
    ...
    test(  'When__try_to_tap_fourth_index_of_prescription__should__go_to_pdf_view_page', () async {
      await driver.runUnsynchronized(() async {
        await driver.tap(Keys.showPrescriptionKey4);
        await Future.delayed(const Duration(seconds: 3), () {});
      });
    });
    ...
    test(
      ...
      await driver.runUnsynchronized(() async {
        await Future.delayed(const Duration(seconds: 2), () {});
        await driver.tap(Keys.prescriptionsSearchKey);
        await Future.delayed(const Duration(seconds: 2), () {});
        await driver.tap(Keys.prescriptionSearchFieldKey);
        await driver.enterText('C52103001518');
        await Future.delayed(const Duration(seconds: 2), () {});
        await driver.tap(Keys.prescriptionSearchIconKey);
        await Future.delayed(const Duration(seconds: 2), () {});
      });
    });
    ...
    test(
      ...
      await driver.runUnsynchronized(() async {
        await Future.delayed(const Duration(seconds: 2), () {});
        await driver.tap(Keys.prescriptionDownloadKey4);
        await Future.delayed(const Duration(seconds: 2), () {});
      });
    });
    ...
    test(
      ...
      await driver.runUnsynchronized(() async {
        await Future.delayed(const Duration(seconds: 2), () {});
        await driver.tap(Keys.prescriptionShareKey4);
        await Future.delayed(const Duration(seconds: 2), () {});
